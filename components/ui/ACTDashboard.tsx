...
function DashboardStat({ 
  ...
  const iconColorClass = stat.color || 'text-spring-green';
        ...
        <div>
          ...
          {stat.change && (
            <div className="flex items-center mt-1">
              {stat.trend === 'up' && (
                <svg className="w-3 h-3 mr-1 text-ios-green" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="18 15 12 9 6 15"></polyline>
                </svg>
              )}
              {stat.trend === 'down' && (
                <svg className="w-3 h-3 mr-1 text-ios-red" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
