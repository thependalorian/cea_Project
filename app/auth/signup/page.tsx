/**
 * SignUp Page Component - ACT Brand Compliant
 * Purpose: User registration implementing ACT brand guidelines
          ...
          <BrandFrame className="bg-white bg-opacity-95 backdrop-blur-sm">
            <div className="text-center mb-act-2">
              ...
              <p className="act-body text-moss-green">
                Start your career in clean energy and climate solutions
              </p>
            </div>
